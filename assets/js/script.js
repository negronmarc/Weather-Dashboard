...
const getWeatherData = (city) => {
  ...
  fetch(
    `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=imperial&appid=155f7a6ae08ca2ba85dcc327be23ef3c`
  )
    ...
    .then((data) => {
      ...
      fetch(
        `https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${lon}&appid=155f7a6ae08ca2ba85dcc327be23ef3c`
      )
        .then((response) => response.json())
        .then((data) => {
  ...
  fetch(
    `https://api.openweathermap.org/data/2.5/forecast?q=${city}&units=imperial&appid=155f7a6ae08ca2ba85dcc327be23ef3c`
  )
    .then((response) => response.json())
    .then((data) => {
